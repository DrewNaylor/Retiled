...
<br>Monochromatic icon theme based on Suru++ which was based on Suru. This will be super helpful as it's mostly a white icon set as far as I can tell, at least for the apps like Firefox. Some stuff isn't white though, so I guess I can modify Microsoft's Fluent-Icons repo for that. I forked it here: https://github.com/drewnaylor/suru-plus-aspromauros
