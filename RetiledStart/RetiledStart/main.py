...
class GetAppIcon(QObject):
	...
	def getIcon(self, DotDesktopFile, RequestedIconTheme):
		...
		if len(DotDesktopFile) > 0:
			iconPath = IconTheme.getIconPath(desktopEntryStuff.getInfo("".join(["/usr/share/applications/", DotDesktopFile]), "Icon", DotDesktopFile, "", True), 96, theme = RequestedIconTheme)
